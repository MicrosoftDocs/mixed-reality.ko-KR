# <a name="2-getting-unity-ready-for-development"></a><span data-ttu-id="126c4-101">2. Unity를 개발할 준비 하는 중</span><span class="sxs-lookup"><span data-stu-id="126c4-101">2. Getting Unity ready for development</span></span> 
