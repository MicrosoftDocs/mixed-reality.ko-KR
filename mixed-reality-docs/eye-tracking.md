...
HoloLens 2를 사용 하면 개발자에 게 사용자가 보고 있는 항목에 대 한 정보를 사용할 수 있는 기능을 제공 하 여 holographic 환경 내에서 새로운 수준의 컨텍스트 및 인간 이해를 허용할 수 있습니다. 이 페이지에서는 개발자와 디자이너에서 다양 한 사용 사례 및 기본 개발자 지침에 대 한 눈 추적을 활용할 수 있는 방법에 대 한 개요를 제공 합니다. 
...
위에서 설명한 것 처럼 아이 추적 데이터를 사용할 수 없는 몇 가지 이유가 있습니다.   
