...
HoloLens 2는 사용자가 보고 있는 대상에 대한 정보를 사용할 수 있는 기능을 개발자에게 제공하여 홀로그램 환경 내에서 이해할 수 있는 새로운 수준의 컨텍스트 및 사용자를 허용합니다. 이 페이지에서는 개발자와 디자이너에서 다양 한 사용 사례 및 기본 개발자 지침에 대 한 눈 추적을 활용할 수 있는 방법에 대 한 개요를 제공 합니다. 


## <a name="calibration"></a>보정 
눈 추적을 정확 하 게 수행 하려면 각 사용자가 holographic 대상 집합을 확인 해야 하는 [눈 추적 사용자 보정](calibration.md) 을 통과 해야 합니다. 이를 통해 장치는 사용자에 게 더 편안 하 고 높은 품질의 시청 환경을 제공 하 고 동시에 정확한 시각 추적을 보장 합니다. 시각 추적은 대부분의 사용자에 게 작동 하지만 사용자가 성공적으로 보정할 수 없는 드문 경우도 있습니다.
...
-   **원격 눈-응시 시각화:** 공유 이해를 높이기 위해 보고 있는 원격 협력자를 시각화 합니다.
-   **사용자 연구 연구:** 주의 추적을 사용 하면 사용자가 보다 instinctual 상호 작용 하는 데 도움이 되는 사용자 환경 모델을 개선 하는 데 도움이 될 수 있는 환경을 인식 하 고 사용 하는 방법을 보다 잘 이해할 수 있습니다. 
-   **교육:** 전문가의 시각적 검색 패턴을 보다 잘 이해 하 고 의료 데이터 분석 또는 운영 체제와 같은 복잡 한 작업에 대 한 시각적인 조정을 통해 초보자의 교육을 개선 했습니다.
-   **디자인 평가 및 시장 연구:** 눈 추적은 웹 사이트 및 제품 디자인을 평가할 때 시장 연구를 위한 일반적인 도구입니다. HoloLens 2를 사용 하 여 디지털 제품 디자인 변형을 물리적 환경에 병합 하 여이를 3D 공간으로 확장할 수 있습니다. 
...
한편, 눈에 눈을 이동 하면 눈에 잘 맞는 입력을 사용 하는 방법에 주의 해야 합니다. 그렇지 않으면 사용자가 경험을 과도 하 게 사용 하지 못할 수 있기 때문입니다. 반면 사용자를 흥미 하는 진정한 마법 환경을 만들 수도 있습니다. 이를 돕기 위해 주요 이점, 문제 및 디자인에 대 한 권장 사항에 대 한 개요를 확인 하 여 [상호 작용](eye-gaze-interaction.md)합니다. 

<br>
 
## <a name="dev-guidance-what-if-eye-tracking-is-not-available"></a>개발 지침: 눈동자 추적을 사용할 수 없는 경우 어떻게 되나요?
...
* ... 시스템은 눈 추적을 모두 지원 합니다. 다음 *메서드*를 호출 합니다. [EyesPose ()](https://docs.microsoft.com/uwp/api/windows.perception.people.eyespose.issupported#Windows_Perception_People_EyesPose_IsSupported)

* ... 사용자가 보정 됩니다. 다음 *속성*을 호출 합니다. [EyesPose. IsCalibrationValid](https://docs.microsoft.com/uwp/api/windows.perception.people.eyespose.iscalibrationvalid#Windows_Perception_People_EyesPose_IsCalibrationValid)

* ... 사용자는 자신의 아이 추적 데이터를 사용할 수 있는 앱 권한을 제공 합니다. 현재 _' GazeInputAccessStatus '_ 를 검색 합니다. 이 작업을 수행 하는 방법에 대 한 예제는 [응시 입력에 대 한 액세스 요청](https://docs.microsoft.com/windows/mixed-reality/gaze-in-directX#requesting-access-to-gaze-input)에 설명 되어 있습니다.
...
* [조정](calibration.md)
* [편안함](comfort.md)
* [눈동자-응시 기반 상호 작용](eye-gaze-interaction.md)
