...
HoloLens 2를 사용할 경우 머리 응시 대신 시선 응시를 사용하여 응시 및 커밋을 더 빠르고 편안하게 만들 수 있습니다. 이를 통해 일반적인 [머리 응시 및 커밋](gaze-and-commit.md) 상호 작용 모델을 다음과 같이 확장할 수 있습니다. 
1. 단순히 대상 바라보기 
...
그러나 시선 응시는 어떤 측면에서 머리 응시와 매우 다르게 동작하므로 독특한 여러 문제를 수반합니다. [시선 응시 디자인 지침](eye-tracking.md)에서는 홀로그래픽 앱에서 시선 추적을 입력으로 사용할 경우의 이점과 고려해야 할 문제점을 요약해서 설명합니다. 이 섹션에서는 시선 응시 및 커밋에 대한 특정 디자인 고려 사항을 중점적으로 설명합니다.
