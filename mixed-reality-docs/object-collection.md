...
![개체 컬렉션을 사용 하는 2D 이미지의 예](images/640px-layout-2dimages.jpg)<br>
*2D 이미지를 사용 하 여 개체 컬렉션을 사용 하는 예제*

## <a name="see-also"></a>참조
* [GitHub의 Mixed Reality 도구 키트에 있는 개체 컬렉션에 대 한 스크립트 및 prefabs](https://github.com/microsoft/MixedRealityToolkit-Unity/blob/mrtk_release/Documentation/README_ObjectCollection.md)
