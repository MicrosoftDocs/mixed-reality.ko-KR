...
:::row:::
    :::column:::
       Near Select](images/HandCoach/NearSelect.gif)의 ![예<br>
       **거의 선택 된 사용 예 단추를 선택 하거나 interactable 개체를 닫는 방법을 보여 줍니다.**<br>
    :::column-end:::
    :::column:::
       ![Air 탭의 예제](images/HandCoach/AirTap.gif)<br>
        **멀리 떨어져 있는 개체를 선택 하는 방법을 보여 주는 데 사용 되는 공기 탭의 예**<br>
    :::column-end:::
    :::column:::
       이동](images/HandCoach/Move.gif) 예 ![<br>
       **공간에서 홀로그램을 이동 하는 방법을 보여 주는 데 사용 되는 개체를 공간으로 이동 하는 예제**<br>
    :::column-end:::
    :::column:::
       회전](images/HandCoach/Rotate.gif) 예제 ![<br>
       **회전-holograms 또는 개체를 회전 하는 방법을 보여 주는 데 사용 되는 예**<br>
    :::column-end:::
:::row-end:::

:::row:::
    :::column:::
       크기 조정](images/HandCoach/Scale.gif)의 ![예제<br>
       **Holograms를 더 크거나 작게 조작 하는 방법을 보여 주기 위해 사용 하는 규모의 예**<br>
    :::column-end:::
    :::column:::
       팜 위로](images/HandCoach/PalmUp.gif) 예제 ![<br>
        **팜 up – 제안 된 사용의 예**<br>
    :::column-end:::
    :::column:::
       ![수동 전환](images/HandCoach/HandFlip.gif)의 예<br>
       **직접 대칭 이동-메뉴를 표시 하는 다른 방법**<br>
    :::column-end:::
    :::column:::
       Scroll](images/HandCoach/Scoll.gif)의 ![예제<br>
...
실습에 애니메이션을 적용 하는 경우 분명 하 게 shoudn't 혼동을 발생 시킵니다. 바늘의 애니메이션은 사용자에 게 하기 호출할 사용자를 이해 하려는 제스처를 나타냅니다. 
...
*   애니메이션에 만족 하는 경우:
    ...
    *  여러 애니메이션이 있는 경우 Maya의 기본 제공 게임 내보내기: https://knowledge.autodesk.com/support/maya/learn-explore/caas/CloudHelp/cloudhelp/2015/ENU/Maya/files/Game-Exporter-htm.html을 사용할 수 있습니다.
...
* [Unity 프로젝트 구성](Configure-Unity-Project.md)
