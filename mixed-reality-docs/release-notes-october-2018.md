...
ms.locfileid: "63524269"
---
# <a name="release-notes---october-2018"></a>릴리스 정보-10 월 2018
...
* **[Qr 코드 추적](qr-code-tracking.md)** -혼합 현실 앱에서 qr 코드 추적을 사용 하도록 설정 하 여 WINDOWS의 VR (mixed reality 몰입) 헤드셋에서 qr 코드를 검색 하 고이를 관심이 있는 앱에 다시 보고 하도록 허용 합니다.
...
* **[혼합 현실 캡처 ui를 몰입 형 앱에 통합](mixed-reality-capture-for-developers.md#integrating-mrc-functionality-from-within-your-app)** -개발자는 몇 줄의 코드만으로 기본 제공 Windows [카메라 캡처 ui](https://docs.microsoft.com/windows/uwp/audio-video-camera/capture-photos-and-video-with-cameracaptureui) 를 사용 하 여 혼합 현실 캡처를 앱에 통합할 수 있습니다.
...
* **빠른 작업 메뉴** -몰입 형 혼합 현실 앱 내에서 Windows 단추를 클릭 하 여 *비디오 녹화를 시작*하 고, *그림을 가져오고*, *혼합 된 현실 홈*, 변경 내용을 쉽게 액세스할 수 있는 새 빠른 작업 메뉴에 액세스할 수 있습니다.  *볼륨*을 만들고 *연결*합니다.
