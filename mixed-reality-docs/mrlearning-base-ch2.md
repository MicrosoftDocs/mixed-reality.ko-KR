...
계층 창에서 선택한 **MixedRealityToolkit** 개체를 사용 하 여, 검사기 창에서 Mixed Reality Toolkit **구성 프로필** 을 **DefaultHoloLens2ConfigurationProfile**로 변경 합니다.

![mrlearning-base](images/mrlearning-base/tutorial2-section1-step1-1.png)

**MixedRealityToolkit** 개체가 선택 된 상태에서 검사기 창에서 **복사 & 사용자 지정** 단추를 클릭 하 여 복제 프로필 창을 엽니다.
...
계층 창에서 **PressableButtonHoloLens2** 개체를 선택한 다음, **검사기** 창 **햄버거 메뉴**에서 **모든 구성 요소 축소** 를 선택 하 여이 개체의 모든 구성 요소에 대 한 개요를 가져옵니다.
...
이벤트 **추가** 단추를 클릭 하 여 이벤트 수신기 유형의 새 이벤트 수신기를 **만듭니다.**
...
새로 만든 이벤트 수신기의 경우 **상호 작용 필터** 를 **Near 및 Far**로 변경 합니다.
...
**반복** On Release 이벤트의 경우 4 단계를 통해 **릴리스 ()** 이벤트의 받는 사람으로 **큐브** 를 할당 합니다.
