...
|  Pitch |  위쪽/아래쪽 화살표 |  위로/아래로 끌기 |  오른쪽 엄지 스틱 위쪽/아래쪽 | 
|  Roll |  Q/E |  |  DPad left/right | 
|  X |  A/D |  |  왼쪽 엄지 스틱 왼쪽/오른쪽 | 
|  예 |  Page up/page down |  |  DPad up/down | 
...
|  Pitch |  위쪽/아래쪽으로 설정 |  손 모양 위로/아래로 이동 |  위쪽/아래쪽으로 설정 | 아이 응시에서 위/아래로 조회 | 
|  Roll |  왼쪽/오른쪽 롤 헤드 |  |  왼쪽/오른쪽 롤 헤드 | (작업 없음) |
|  X |  왼쪽/오른쪽으로 슬라이드 본문 |  손 모양/컨트롤러를 왼쪽/오른쪽으로 이동 |  왼쪽/오른쪽으로 설정 | (작업 없음) |
|  예 |  본문을 위/아래로 이동 |  손 모양/컨트롤러 위로/아래로 이동 |  위쪽/아래쪽으로 설정 | (작업 없음) |
