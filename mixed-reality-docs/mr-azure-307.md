...
9.  선택는 **모델 학습** 캔버스 및 항목은 **속성** 패널 (브라우저 창의 오른쪽) 클릭 합니다 **열 선택기 시작** 단추.
...
24. 로 노출 해야 새로 학습 된 기계 학습 모델을 사용 하는 **웹 서비스**합니다. 이 작업을 수행 하려면 클릭 합니다 **웹 서비스 설정** 메뉴 페이지의 맨 위에 있는 메뉴에서 항목을 클릭할 **예측 웹 서비스**합니다.
