...
|---------|---------|---------|---------|
|**확대 현실 멜버른**|오스트레일리아|멜버른|[링크나](https://www.meetup.com/armelbourne/)|
|**시카고 AWE Nite**|인도네시아|시카고|[링크나](https://www.meetup.com/AWENiteChicago/)|
|**HoloMagicians**|Japan|도쿄|[링크나](https://hololens.connpass.com/)|
...
|||||
|---------|---------|---------|---------|
|<![Daniel Escudero](images/BiographyImages/DanielEscudero_270x270.jpg)</br>**Daniel Escudero**</br>*MR 아카데미 리드 디자이너*|대화형 디자이너, prototyper 및 코드 작성자 있는지는 혼합 현실에서 특수 한 것으로, 15 년간의 상호 작용 디자인 환경을 제공 합니다. 현재는 혼합 현실에서 새로운 형태의 상호 작용을 설계 하 고 프로토타입 하 고 샌프란시스코 베이 영역 파트너와 MR/VR/AR 커뮤니티를 사용 하 여 작업장 및 해커 톤 행사를 만들 수도 있습니다. 혼합 현실의 전문가 및 스피커가 여러 MR/VR/AR 이벤트 및 강의에서 설계 되었습니다.|샌프란시스코, Ca|[메일 주소](mailto:daescu@microsoft.com)|
|<!-- ![Daniel Gonzalez](images/BiographyImages/) --></br>**Daniel Gonzalez**</br>*프로그램 관리자 II*| |Redmond, Wa|[메일 주소](mailto:dgonza@microsoft.com)|
|<!-- ![Jane Fang](images/BiographyImages/) --></br>**Jane Fang**</br>*주 프로그램 관리자 리드*| |샌프란시스코, Ca|[메일 주소](mailto:jafang@microsoft.com)|
|![Jesse McCulloch](images/BiographyImages/JesseMcCulloch270x270.png)</br>**Jesse McCulloch**</br>*프로그램 관리자 II*|Jesse는 Microsoft에서 혼합 현실 개발자 에코 시스템의 프로그램 관리자입니다. 이러한 작업은 신속 하 게 증가 하는 공간에서 발생 하는 모든 항목을 포함 하는 Twitter의 경우 나 실제 세계의 개발자와 관련 하 여 공기를 이동 하는 큰 금속 튜브에서 중단 되는 경우가 종종 있습니다.|Redmond, Wa|[메일 주소](mailto:jemccull@microsoft.com)|
|<!-- ![Jo Ryall](images/BiographyImages/) --></br>**Jo Ryall**</br>*마케팅의 헤드, SF 아카데미*| |샌프란시스코, Ca|[메일 주소](mailto:joryal@microsoft.com)|
|![Nick Klingensmith](images/BiographyImages/NickKlingensmith_270x270.png)</br>**Nick Klingensmith**</br>*MR 아카데미 리드 엔지니어*|Nick는 도구 개발, 그래픽 프로그래밍, MR 및 Unity를 전문으로 하는 숙련 된 게임 개발자입니다. 100 개 이상의 게시 된 게임을 통해 소형 아케이드 게임, 모바일 고품질 GPU 푸시 타이틀, 대규모 네트워크 소셜 게임에 대해 작업 했습니다. Unity Asset Store에 게시 된 도구는 모든 최신 플랫폼 에서도에 대해서만 수천 개의 게임과 함께 사용 됩니다. Nick는 대부분의 공식 Unity 인증을 수집 하 고이를 작성 하는 데도 도움이 되었습니다. Nick는 현재 Microsoft가 샌프란시스코의 Mixed Reality 아카데미 팀에서 수석 엔지니어로 작업 하 고 있습니다.|샌프란시스코, Ca|[메일 주소](mailto:niklinge@microsoft.com)|
