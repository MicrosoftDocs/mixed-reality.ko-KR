...
[음성 입력](voice-input.md) 은 자연 스러운 형태의 상호 작용입니다. 사용자 환경은 사용자가 선택한 명령과 사용자의 공개 방법에 따라 마법 또는 혼란 스 러 울 수 있습니다. 규칙으로 "선택" 또는 "안녕 코타"와 같은 시스템 음성 명령을 사용자 지정 명령으로 사용 하면 안 됩니다. 고려해 야 할 몇 가지 사항은 다음과 같습니다.
...
사용자는 [주변 장치](hardware-accessories.md)를 통해 앱과 상호 작용할 수 있습니다. 앱은 이러한 기능을 활용 하기 위해 특별 한 작업을 수행할 필요가 없지만, 몇 가지 사항을 확인 하는 것이 좋습니다.
