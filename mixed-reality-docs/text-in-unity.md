...
텍스트를 선명 하 고 멋진 텍스트를 가져오는 방법 ![](images/hug-text-02-640px.png)<br>
*Unity의 흐린 기본 텍스트*
...
Unity에서 글꼴 작업을 ![](images/640px-hug-text-03.png)<br>
...
다른 글꼴 크기가 있는 Unity 3D 텍스트 메시를 ![](images/Text_In_Unity_Measurements1.png)<br>
*Unity 3D 텍스트 및 UI 텍스트에 대 한 값 크기 조정*

<br>

다른 글꼴 크기가 있는 Unity 3D 텍스트 메시를 ![](images/hug-text-05-1000px.png)<br>
...
단위 값 마다 다른 동적 픽셀을 사용 하 여 Unity UI 텍스트를 ![](images/hug-text-04-1000px.png)<br>
...
다른 글꼴 크기가 있는 Unity 3D 텍스트 메시를 ![](images/Text_In_Unity_Measurements2.png)<br>
*Unity 3D 텍스트 및 UI 텍스트에 대 한 값 크기 조정*
...
적절 한 차원을 사용 하 여 선명한 텍스트 렌더링 품질을 ![](images/hug-text-06-1000px.png)<br>
...
폐색 지원](images/hug-text-07-1000px.png)를 사용 하는 ![셰이더<br>
*폐색가 지원 되는 셰이더*
