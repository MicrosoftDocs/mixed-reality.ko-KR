...
## <a name="creating-an-iperceptionsimulation-manager-object"></a><span data-ttu-id="1fdf9-135">IPerceptionSimulation Manager 개체 만들기</span><span class="sxs-lookup"><span data-stu-id="1fdf9-135">Creating an IPerceptionSimulation Manager Object</span></span>
...
<span data-ttu-id="1fdf9-177">프로세스의 종료 코드는 성공 (0이 아닌 반환 값) 또는 실패 (0이 아닌 반환 값)를 표시 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-177">The exit code of the process will indicate success (a zero return value) or failure (a non-zero return value).</span></span>  <span data-ttu-id="1fdf9-178">' Q ' 작업을 사용 하 여 컨트롤러가 설치 되어 있는지 여부를 쿼리하려면 컨트롤러를 아직 설치 하지 않은 경우 반환 값은 0이 고, 컨트롤러가 설치 된 경우에는 (1)입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-178">When using the 'q' action to query whether or not a controller is installed, the return value will be zero (0) if the controller is not already installed or one (1) if the controller is installed.</span></span>
...
<span data-ttu-id="1fdf9-200">제스처를 표시 하는 데 사용 되는 센티널 값입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-200">A sentinel value used to indicate no gestures.</span></span>
...
<span data-ttu-id="1fdf9-213">**PerceptionSimulation. SimulatedSixDofControllerStatus**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-213">**Microsoft.PerceptionSimulation.SimulatedSixDofControllerStatus.Active**</span></span>
...
<span data-ttu-id="1fdf9-224">메뉴 단추가 눌러져 있습니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-224">The Menu button is pressed.</span></span>
...
<span data-ttu-id="1fdf9-239">**PerceptionSimulation. SimulatedEyesCalibrationState**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-239">**Microsoft.PerceptionSimulation.SimulatedEyesCalibrationState.Unavailable**</span></span>
...
<span data-ttu-id="1fdf9-253">조인트 위치가 유추 됩니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-253">The joint position is inferred.</span></span>
...
<span data-ttu-id="1fdf9-265">손 모양 손가락 조인트는 집기 포즈를 반영 하도록 구성 됩니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-265">The hand's finger joints are configured to reflect a pinching pose.</span></span>
...
<span data-ttu-id="1fdf9-279">3D 공간에서 점이 나 벡터를 설명할 수 있는 3 개의 구성 요소 벡터에 대해 설명 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-279">Describes a 3 components vector, which might describe a point or a vector in 3D space.</span></span>
...
<span data-ttu-id="1fdf9-294">**PerceptionSimulation. Rotation3**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-294">**Microsoft.PerceptionSimulation.Rotation3.Pitch**</span></span>
...
<span data-ttu-id="1fdf9-309">조인트의 위치입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-309">The position of the joint.</span></span>
...
<span data-ttu-id="1fdf9-323">뷰의 가로 필드와 세로 필드의 비율입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-323">The ratio of horizontal field of view to vertical field of view.</span></span>
...
<span data-ttu-id="1fdf9-334">**PerceptionSimulation. SimulatedDisplayConfiguration. Ipd**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-334">**Microsoft.PerceptionSimulation.SimulatedDisplayConfiguration.Ipd**</span></span>
...
<span data-ttu-id="1fdf9-346">**PerceptionSimulation. IPerceptionSimulationManager**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-346">**Microsoft.PerceptionSimulation.IPerceptionSimulationManager.Reset**</span></span>
...
<span data-ttu-id="1fdf9-359">ISimulatedDevice을 ISimulatedDevice2로 캐스팅 하 여 추가 속성을 사용할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-359">Additional properties are available by casting the ISimulatedDevice to ISimulatedDevice2</span></span>
...
<span data-ttu-id="1fdf9-369">시뮬레이션 된 사람의 손을 추적 하는 시뮬레이션 된 장치의 부분을 설명 하는 인터페이스입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-369">Interface describing the portion of the simulated device that tracks the hands of the simulated human</span></span>
...
<span data-ttu-id="1fdf9-381">손을 시뮬레이션 된 손 추적기에 표시할지 여부를 결정 하는 데 사용 되는 대/그와 같은 속성을 검색 하 고 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-381">Retrieve and set the frustum properties used to determine if hands are visible to the simulated hand tracker.</span></span>
...
<span data-ttu-id="1fdf9-393">**PerceptionSimulation. ISimulatedHuman. LeftHand**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-393">**Microsoft.PerceptionSimulation.ISimulatedHuman.LeftHand**</span></span>
...
<span data-ttu-id="1fdf9-417">**PerceptionSimulation. ISimulatedHand**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-417">**Microsoft.PerceptionSimulation.ISimulatedHand.Position**</span></span>

<span data-ttu-id="1fdf9-418">미터 단위로 인간을 기준으로 시뮬레이션 된 손의 위치를 검색 하 고 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-418">Retrieve and set the position of the simulated hand relative to the human, in meters.</span></span>

<span data-ttu-id="1fdf9-419">**PerceptionSimulation. ISimulatedHand**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-419">**Microsoft.PerceptionSimulation.ISimulatedHand.Activated**</span></span>

<span data-ttu-id="1fdf9-420">손이 현재 활성화 되어 있는지 여부를 검색 하 고 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-420">Retrieve and set whether the hand is currently activated.</span></span>

<span data-ttu-id="1fdf9-421">**PerceptionSimulation. ISimulatedHand**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-421">**Microsoft.PerceptionSimulation.ISimulatedHand.Visible**</span></span>

<span data-ttu-id="1fdf9-422">손이 현재 SimulatedDevice에 표시 되는지 여부를 검색 합니다 .이는 핸드 트래커에서 검색할 위치에 있는지 여부를 검색 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-422">Retrieve whether the hand is currently visible to the SimulatedDevice (ie, whether it's in a position to be detected by the HandTracker).</span></span>

<span data-ttu-id="1fdf9-423">\**PerceptionSimulation. ISimulatedHand. Ensurevisible\**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-423">**Microsoft.PerceptionSimulation.ISimulatedHand.EnsureVisible**</span></span>

<span data-ttu-id="1fdf9-424">SimulatedDevice에 표시 되도록 손을 이동 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-424">Move the hand such that it is visible to the SimulatedDevice.</span></span>

<span data-ttu-id="1fdf9-425">**PerceptionSimulation (ISimulatedHand (PerceptionSimulation. Vector3)**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-425">**Microsoft.PerceptionSimulation.ISimulatedHand.Move(Microsoft.PerceptionSimulation.Vector3)**</span></span>

<span data-ttu-id="1fdf9-426">현재 위치를 기준으로 시뮬레이션 된 손의 위치를 미터 단위로 이동 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-426">Move the position of the simulated hand relative to its current position, in meters.</span></span>

<span data-ttu-id="1fdf9-427">매개 변수</span><span class="sxs-lookup"><span data-stu-id="1fdf9-427">Parameters</span></span>
* <span data-ttu-id="1fdf9-428">번역-시뮬레이션 된 손을 변환할 양입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-428">translation - The amount to translate the simulated hand.</span></span>

<span data-ttu-id="1fdf9-429">**PerceptionSimulation ISimulatedHand. PerformGesture (PerceptionSimulation)**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-429">**Microsoft.PerceptionSimulation.ISimulatedHand.PerformGesture(Microsoft.PerceptionSimulation.SimulatedGesture)**</span></span>

<span data-ttu-id="1fdf9-430">시뮬레이션 된 손을 사용 하 여 제스처를 수행 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-430">Perform a gesture using the simulated hand.</span></span>  <span data-ttu-id="1fdf9-431">손을 사용 하도록 설정 된 경우에만 시스템에서 검색 됩니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-431">It will only be detected by the system if the hand is enabled.</span></span>

<span data-ttu-id="1fdf9-432">매개 변수</span><span class="sxs-lookup"><span data-stu-id="1fdf9-432">Parameters</span></span>
* <span data-ttu-id="1fdf9-433">제스처-수행할 제스처입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-433">gesture - The gesture to perform.</span></span>

### <a name="microsoftperceptionsimulationisimulatedhand2"></a><span data-ttu-id="1fdf9-434">PerceptionSimulation. ISimulatedHand2</span><span class="sxs-lookup"><span data-stu-id="1fdf9-434">Microsoft.PerceptionSimulation.ISimulatedHand2</span></span>

<span data-ttu-id="1fdf9-435">ISimulatedHand을 ISimulatedHand2로 캐스팅 하 여 추가 속성을 사용할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-435">Additional properties are available by casting an ISimulatedHand to ISimulatedHand2.</span></span>
```
...
<span data-ttu-id="1fdf9-436">**PerceptionSimulation. ISimulatedHand2**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-436">**Microsoft.PerceptionSimulation.ISimulatedHand2.Orientation**</span></span>

<span data-ttu-id="1fdf9-437">시뮬레이션 된 손 각도를 검색 하거나 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-437">Retrieve or set the rotation of the simulated hand.</span></span>  <span data-ttu-id="1fdf9-438">양수 라디안은 축을 따라 볼 때 시계 방향으로 회전 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-438">Positive radians rotate clockwise when looking along the axis.</span></span>

### <a name="microsoftperceptionsimulationisimulatedhand3"></a><span data-ttu-id="1fdf9-439">PerceptionSimulation. ISimulatedHand3</span><span class="sxs-lookup"><span data-stu-id="1fdf9-439">Microsoft.PerceptionSimulation.ISimulatedHand3</span></span>

<span data-ttu-id="1fdf9-440">ISimulatedHand을 ISimulatedHand3로 캐스팅 하 여 추가 속성을 사용할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-440">Additional properties are available by casting an ISimulatedHand to ISimulatedHand3</span></span>
```
...
<span data-ttu-id="1fdf9-441">**PerceptionSimulation. ISimulatedHand3. GetJointConfiguration**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-441">**Microsoft.PerceptionSimulation.ISimulatedHand3.GetJointConfiguration**</span></span>

<span data-ttu-id="1fdf9-442">지정 된 조인트의 조인트 구성을 가져옵니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-442">Get the joint configuration for the specified joint.</span></span>

<span data-ttu-id="1fdf9-443">**PerceptionSimulation. ISimulatedHand3. SetJointConfiguration**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-443">**Microsoft.PerceptionSimulation.ISimulatedHand3.SetJointConfiguration**</span></span>

<span data-ttu-id="1fdf9-444">지정 된 조인트의 조인트 구성을 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-444">Set the joint configuration for the specified joint.</span></span>

<span data-ttu-id="1fdf9-445">**PerceptionSimulation. ISimulatedHand3. SetHandPose**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-445">**Microsoft.PerceptionSimulation.ISimulatedHand3.SetHandPose**</span></span>

<span data-ttu-id="1fdf9-446">애니메이션 효과를 주는 선택적 플래그를 사용 하 여 손 모양을 알려진 포즈로 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-446">Set the hand to a known pose with an optional flag to animate.</span></span>  <span data-ttu-id="1fdf9-447">참고: 애니메이션 효과는 최종 조인트 구성을 즉시 반영 하지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-447">Note: animating won't result in joints immediately reflecting their final joint configurations.</span></span>


### <a name="microsoftperceptionsimulationisimulatedhead"></a><span data-ttu-id="1fdf9-448">PerceptionSimulation. ISimulatedHead</span><span class="sxs-lookup"><span data-stu-id="1fdf9-448">Microsoft.PerceptionSimulation.ISimulatedHead</span></span>

<span data-ttu-id="1fdf9-449">시뮬레이션 된 사람의 머리를 설명 하는 인터페이스입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-449">Interface describing the head of the simulated human.</span></span>
...
<span data-ttu-id="1fdf9-450">**PerceptionSimulation. ISimulatedHead. WorldPosition**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-450">**Microsoft.PerceptionSimulation.ISimulatedHead.WorldPosition**</span></span>

<span data-ttu-id="1fdf9-451">전 세계와 관련 하 여 노드의 위치를 미터 단위로 검색 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-451">Retrieve the position of the node with relation to the world, in meters.</span></span>

<span data-ttu-id="1fdf9-452">**PerceptionSimulation. ISimulatedHead**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-452">**Microsoft.PerceptionSimulation.ISimulatedHead.Rotation**</span></span>

<span data-ttu-id="1fdf9-453">시뮬레이션 된 헤드의 회전을 검색 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-453">Retrieve the rotation of the simulated head.</span></span> <span data-ttu-id="1fdf9-454">양수 라디안은 축을 따라 볼 때 시계 방향으로 회전 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-454">Positive radians rotate clockwise when looking along the axis.</span></span>

<span data-ttu-id="1fdf9-455">**PerceptionSimulation. ISimulatedHead**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-455">**Microsoft.PerceptionSimulation.ISimulatedHead.Diameter**</span></span>

<span data-ttu-id="1fdf9-456">시뮬레이션 된 헤드의 지름을 검색 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-456">Retrieve the simulated head's diameter.</span></span> <span data-ttu-id="1fdf9-457">이 값은 헤드의 중심 (회전 지점)을 결정 하는 데 사용 됩니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-457">This value is used to determine the head's center (point of rotation).</span></span>

<span data-ttu-id="1fdf9-458">**PerceptionSimulation. ISimulatedHead (PerceptionSimulation. Rotation3)**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-458">**Microsoft.PerceptionSimulation.ISimulatedHead.Rotate(Microsoft.PerceptionSimulation.Rotation3)**</span></span>

<span data-ttu-id="1fdf9-459">현재 회전을 기준으로 시뮬레이션 된 헤드를 회전 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-459">Rotate the simulated head relative to its current rotation.</span></span> <span data-ttu-id="1fdf9-460">양수 라디안은 축을 따라 볼 때 시계 방향으로 회전 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-460">Positive radians rotate clockwise when looking along the axis.</span></span>

<span data-ttu-id="1fdf9-461">매개 변수</span><span class="sxs-lookup"><span data-stu-id="1fdf9-461">Parameters</span></span>
* <span data-ttu-id="1fdf9-462">회전-회전할 양입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-462">rotation - The amount to rotate.</span></span>

### <a name="microsoftperceptionsimulationisimulatedhead2"></a><span data-ttu-id="1fdf9-463">PerceptionSimulation. ISimulatedHead2</span><span class="sxs-lookup"><span data-stu-id="1fdf9-463">Microsoft.PerceptionSimulation.ISimulatedHead2</span></span>

<span data-ttu-id="1fdf9-464">ISimulatedHead을 ISimulatedHead2로 캐스팅 하 여 추가 속성을 사용할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-464">Additional properties are available by casting an ISimulatedHead to ISimulatedHead2</span></span>
...
<span data-ttu-id="1fdf9-465">**PerceptionSimulation. ISimulatedHead2**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-465">**Microsoft.PerceptionSimulation.ISimulatedHead2.Eyes**</span></span>

<span data-ttu-id="1fdf9-466">시뮬레이션 된 사람의 눈동자를 검색 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-466">Retrieve the eyes of the simulated human.</span></span>

### <a name="microsoftperceptionsimulationisimulatedsixdofcontroller"></a><span data-ttu-id="1fdf9-467">PerceptionSimulation. ISimulatedSixDofController</span><span class="sxs-lookup"><span data-stu-id="1fdf9-467">Microsoft.PerceptionSimulation.ISimulatedSixDofController</span></span>

<span data-ttu-id="1fdf9-468">시뮬레이션 된 사용자와 연결 된 6 DOF 컨트롤러를 설명 하는 인터페이스입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-468">Interface describing a 6-DOF controller associated with the simulated human.</span></span>
...
<span data-ttu-id="1fdf9-469">**PerceptionSimulation. ISimulatedSixDofController. WorldPosition**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-469">**Microsoft.PerceptionSimulation.ISimulatedSixDofController.WorldPosition**</span></span>

<span data-ttu-id="1fdf9-470">전 세계와 관련 하 여 노드의 위치를 미터 단위로 검색 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-470">Retrieve the position of the node with relation to the world, in meters.</span></span>

<span data-ttu-id="1fdf9-471">**PerceptionSimulation. ISimulatedSixDofController**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-471">**Microsoft.PerceptionSimulation.ISimulatedSixDofController.Status**</span></span>

<span data-ttu-id="1fdf9-472">컨트롤러의 현재 상태를 검색 하거나 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-472">Retrieve or set the current state of the controller.</span></span>  <span data-ttu-id="1fdf9-473">이동, 회전 또는 누르기 단추에 대 한 호출이 성공 하기 전에 컨트롤러 상태를 Off 이외의 값으로 설정 해야 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-473">The controller status must be set to a value other than Off before any calls to move, rotate or press buttons will succeed.</span></span>

<span data-ttu-id="1fdf9-474">**PerceptionSimulation. ISimulatedSixDofController**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-474">**Microsoft.PerceptionSimulation.ISimulatedSixDofController.Position**</span></span>

<span data-ttu-id="1fdf9-475">사용자를 기준으로 시뮬레이션 된 컨트롤러의 위치를 미터 단위로 검색 하거나 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-475">Retrieve or set the position of the simulated controller relative to the human, in meters.</span></span>

<span data-ttu-id="1fdf9-476">**PerceptionSimulation. ISimulatedSixDofController**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-476">**Microsoft.PerceptionSimulation.ISimulatedSixDofController.Orientation**</span></span>

<span data-ttu-id="1fdf9-477">시뮬레이션 된 컨트롤러의 방향을 검색 하거나 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-477">Retrieve or set the orientation of the simulated controller.</span></span>

<span data-ttu-id="1fdf9-478">**PerceptionSimulation (ISimulatedSixDofController (PerceptionSimulation. Vector3)**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-478">**Microsoft.PerceptionSimulation.ISimulatedSixDofController.Move(Microsoft.PerceptionSimulation.Vector3)**</span></span>

<span data-ttu-id="1fdf9-479">현재 위치를 기준으로 시뮬레이트된 컨트롤러의 위치를 미터 단위로 이동 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-479">Move the position of the simulated controller relative to its current position, in meters.</span></span>

<span data-ttu-id="1fdf9-480">매개 변수</span><span class="sxs-lookup"><span data-stu-id="1fdf9-480">Parameters</span></span>
* <span data-ttu-id="1fdf9-481">번역-시뮬레이트된 컨트롤러를 변환할 양입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-481">translation - The amount to translate the simulated controller.</span></span>

<span data-ttu-id="1fdf9-482">**PerceptionSimulation. ISimulatedSixDofController (SimulatedSixDofControllerButton)**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-482">**Microsoft.PerceptionSimulation.ISimulatedSixDofController.PressButton(SimulatedSixDofControllerButton)**</span></span>

<span data-ttu-id="1fdf9-483">시뮬레이션 된 컨트롤러의 단추를 누릅니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-483">Press a button on the simulated controller.</span></span>  <span data-ttu-id="1fdf9-484">컨트롤러가 사용 하도록 설정 된 경우에만 시스템에서 검색 됩니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-484">It will only be detected by the system if the controller is enabled.</span></span>

<span data-ttu-id="1fdf9-485">매개 변수</span><span class="sxs-lookup"><span data-stu-id="1fdf9-485">Parameters</span></span>
* <span data-ttu-id="1fdf9-486">button-단추를 누릅니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-486">button - The button to press.</span></span>

<span data-ttu-id="1fdf9-487">**PerceptionSimulation. ISimulatedSixDofController (SimulatedSixDofControllerButton)**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-487">**Microsoft.PerceptionSimulation.ISimulatedSixDofController.ReleaseButton(SimulatedSixDofControllerButton)**</span></span>

<span data-ttu-id="1fdf9-488">시뮬레이션 된 컨트롤러에서 단추를 놓습니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-488">Release a button on the simulated controller.</span></span>  <span data-ttu-id="1fdf9-489">컨트롤러가 사용 하도록 설정 된 경우에만 시스템에서 검색 됩니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-489">It will only be detected by the system if the controller is enabled.</span></span>

<span data-ttu-id="1fdf9-490">매개 변수</span><span class="sxs-lookup"><span data-stu-id="1fdf9-490">Parameters</span></span>
* <span data-ttu-id="1fdf9-491">button-해제할 단추입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-491">button - The button to release.</span></span>

<span data-ttu-id="1fdf9-492">**PerceptionSimulation ISimulatedSixDofController. GetTouchpadPosition (out float, out float)**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-492">**Microsoft.PerceptionSimulation.ISimulatedSixDofController.GetTouchpadPosition(out float, out float)**</span></span>

<span data-ttu-id="1fdf9-493">시뮬레이션 된 컨트롤러의 터치 패드에서 시뮬레이션 된 손가락의 위치를 가져옵니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-493">Get the position of a simulated finger on the simulated controller's touchpad.</span></span>

<span data-ttu-id="1fdf9-494">매개 변수</span><span class="sxs-lookup"><span data-stu-id="1fdf9-494">Parameters</span></span>
* <span data-ttu-id="1fdf9-495">x-손가락의 가로 위치입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-495">x - The horizontal position of the finger.</span></span>
* <span data-ttu-id="1fdf9-496">y-손가락의 세로 위치입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-496">y - The vertical position of the finger.</span></span>

<span data-ttu-id="1fdf9-497">**PerceptionSimulation ISimulatedSixDofController. SetTouchpadPosition (float, float)**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-497">**Microsoft.PerceptionSimulation.ISimulatedSixDofController.SetTouchpadPosition(float, float)**</span></span>

<span data-ttu-id="1fdf9-498">시뮬레이션 된 컨트롤러의 터치 패드에서 시뮬레이션 된 손가락의 위치를 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-498">Set the position of a simulated finger on the simulated controller's touchpad.</span></span>

<span data-ttu-id="1fdf9-499">매개 변수</span><span class="sxs-lookup"><span data-stu-id="1fdf9-499">Parameters</span></span>
* <span data-ttu-id="1fdf9-500">x-손가락의 가로 위치입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-500">x - The horizontal position of the finger.</span></span>
* <span data-ttu-id="1fdf9-501">y-손가락의 세로 위치입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-501">y - The vertical position of the finger.</span></span>

### <a name="microsoftperceptionsimulationisimulatedsixdofcontroller2"></a><span data-ttu-id="1fdf9-502">PerceptionSimulation. ISimulatedSixDofController2</span><span class="sxs-lookup"><span data-stu-id="1fdf9-502">Microsoft.PerceptionSimulation.ISimulatedSixDofController2</span></span>

<span data-ttu-id="1fdf9-503">ISimulatedSixDofController를 ISimulatedSixDofController2로 캐스팅 하 여 추가 속성 및 메서드를 사용할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-503">Additional properties and methods are available by casting an ISimulatedSixDofController to ISimulatedSixDofController2</span></span>
...
<span data-ttu-id="1fdf9-504">**PerceptionSimulation ISimulatedSixDofController2. GetThumbstickPosition (out float, out float)**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-504">**Microsoft.PerceptionSimulation.ISimulatedSixDofController2.GetThumbstickPosition(out float, out float)**</span></span>

<span data-ttu-id="1fdf9-505">시뮬레이트된 컨트롤러에서 시뮬레이션 된 엄지 스틱의 위치를 가져옵니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-505">Get the position of the simulated thumbstick on the simulated controller.</span></span>

<span data-ttu-id="1fdf9-506">매개 변수</span><span class="sxs-lookup"><span data-stu-id="1fdf9-506">Parameters</span></span>
* <span data-ttu-id="1fdf9-507">x-엄지 스틱의 가로 위치입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-507">x - The horizontal position of the thumbstick.</span></span>
* <span data-ttu-id="1fdf9-508">y-엄지 스틱의 세로 위치입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-508">y - The vertical position of the thumbstick.</span></span>

<span data-ttu-id="1fdf9-509">**PerceptionSimulation ISimulatedSixDofController2. SetThumbstickPosition (float, float)**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-509">**Microsoft.PerceptionSimulation.ISimulatedSixDofController2.SetThumbstickPosition(float, float)**</span></span>

<span data-ttu-id="1fdf9-510">시뮬레이트된 컨트롤러에서 시뮬레이션 된 엄지 스틱의 위치를 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-510">Set the position of the simulated thumbstick on the simulated controller.</span></span>

<span data-ttu-id="1fdf9-511">매개 변수</span><span class="sxs-lookup"><span data-stu-id="1fdf9-511">Parameters</span></span>
* <span data-ttu-id="1fdf9-512">x-엄지 스틱의 가로 위치입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-512">x - The horizontal position of the thumbstick.</span></span>
* <span data-ttu-id="1fdf9-513">y-엄지 스틱의 세로 위치입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-513">y - The vertical position of the thumbstick.</span></span>

<span data-ttu-id="1fdf9-514">**PerceptionSimulation. ISimulatedSixDofController2. BatteryLevel**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-514">**Microsoft.PerceptionSimulation.ISimulatedSixDofController2.BatteryLevel**</span></span>

<span data-ttu-id="1fdf9-515">시뮬레이트된 컨트롤러의 배터리 수준을 검색 하거나 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-515">Retrieve or set the battery level of the simulated controller.</span></span>  <span data-ttu-id="1fdf9-516">값은 0.0 보다 크고 100.0 보다 작거나 같아야 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-516">The value must be greater than 0.0 and less than or equal to 100.0.</span></span>


### <a name="microsoftperceptionsimulationisimulatedeyes"></a><span data-ttu-id="1fdf9-517">PerceptionSimulation. ISimulatedEyes</span><span class="sxs-lookup"><span data-stu-id="1fdf9-517">Microsoft.PerceptionSimulation.ISimulatedEyes</span></span>

<span data-ttu-id="1fdf9-518">시뮬레이션 된 사람의 눈을 설명 하는 인터페이스입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-518">Interface describing the eyes of the simulated human.</span></span>
...
<span data-ttu-id="1fdf9-519">**PerceptionSimulation. ISimulatedEyes**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-519">**Microsoft.PerceptionSimulation.ISimulatedEyes.Rotation**</span></span>

<span data-ttu-id="1fdf9-520">시뮬레이션 된 눈동자의 회전을 검색 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-520">Retrieve the rotation of the simulated eyes.</span></span> <span data-ttu-id="1fdf9-521">양수 라디안은 축을 따라 볼 때 시계 방향으로 회전 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-521">Positive radians rotate clockwise when looking along the axis.</span></span>

<span data-ttu-id="1fdf9-522">**PerceptionSimulation. ISimulatedEyes (PerceptionSimulation. Rotation3)**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-522">**Microsoft.PerceptionSimulation.ISimulatedEyes.Rotate(Microsoft.PerceptionSimulation.Rotation3)**</span></span>

<span data-ttu-id="1fdf9-523">현재 회전을 기준으로 시뮬레이션 된 눈동자를 회전 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-523">Rotate the simulated eyes relative to its current rotation.</span></span> <span data-ttu-id="1fdf9-524">양수 라디안은 축을 따라 볼 때 시계 방향으로 회전 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-524">Positive radians rotate clockwise when looking along the axis.</span></span>

<span data-ttu-id="1fdf9-525">매개 변수</span><span class="sxs-lookup"><span data-stu-id="1fdf9-525">Parameters</span></span>
* <span data-ttu-id="1fdf9-526">회전-회전할 양입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-526">rotation - The amount to rotate.</span></span>

<span data-ttu-id="1fdf9-527">**PerceptionSimulation. ISimulatedEyes. CalibrationState**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-527">**Microsoft.PerceptionSimulation.ISimulatedEyes.CalibrationState**</span></span>

<span data-ttu-id="1fdf9-528">시뮬레이션 된 눈동자의 보정 상태를 검색 하거나 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-528">Retrieves or sets the calibration state of the simulated eyes.</span></span>

<span data-ttu-id="1fdf9-529">**PerceptionSimulation. ISimulatedEyes. WorldPosition**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-529">**Microsoft.PerceptionSimulation.ISimulatedEyes.WorldPosition**</span></span>

<span data-ttu-id="1fdf9-530">전 세계와 관련 하 여 노드의 위치를 미터 단위로 검색 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-530">Retrieve the position of the node with relation to the world, in meters.</span></span>


### <a name="microsoftperceptionsimulationisimulationrecording"></a><span data-ttu-id="1fdf9-531">PerceptionSimulation. ISimulationRecording</span><span class="sxs-lookup"><span data-stu-id="1fdf9-531">Microsoft.PerceptionSimulation.ISimulationRecording</span></span>

<span data-ttu-id="1fdf9-532">재생을 위해 로드 된 단일 기록과 상호 작용 하기 위한 인터페이스입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-532">Interface for interacting with a single recording loaded for playback.</span></span>
...
<span data-ttu-id="1fdf9-533">**PerceptionSimulation. ISimulationRecording**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-533">**Microsoft.PerceptionSimulation.ISimulationRecording.DataTypes**</span></span>

<span data-ttu-id="1fdf9-534">기록의 데이터 형식 목록을 검색 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-534">Retrieves the list of data types in the recording.</span></span>

<span data-ttu-id="1fdf9-535">**PerceptionSimulation. ISimulationRecording**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-535">**Microsoft.PerceptionSimulation.ISimulationRecording.State**</span></span>

<span data-ttu-id="1fdf9-536">기록의 현재 상태를 검색 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-536">Retrieves the current state of the recording.</span></span>

<span data-ttu-id="1fdf9-537">**PerceptionSimulation. ISimulationRecording**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-537">**Microsoft.PerceptionSimulation.ISimulationRecording.Play**</span></span>

<span data-ttu-id="1fdf9-538">재생을 시작 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-538">Start the playback.</span></span> <span data-ttu-id="1fdf9-539">기록이 일시 중지 된 경우 일시 중지 된 위치에서 재생이 다시 시작 됩니다. 중지 된 경우 재생이 시작 부분에서 시작 됩니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-539">If the recording is paused, playback will resume from the paused location; if stopped, playback will start at the beginning.</span></span> <span data-ttu-id="1fdf9-540">이미를 재생 하는 경우이 호출은 무시 됩니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-540">If already playing, this call is ignored.</span></span>

<span data-ttu-id="1fdf9-541">**PerceptionSimulation. ISimulationRecording**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-541">**Microsoft.PerceptionSimulation.ISimulationRecording.Pause**</span></span>

<span data-ttu-id="1fdf9-542">현재 위치에서 재생을 일시 중지 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-542">Pauses the playback at its current location.</span></span> <span data-ttu-id="1fdf9-543">기록이 중지 되 면 호출은 무시 됩니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-543">If the recording is stopped, the call is ignored.</span></span>

<span data-ttu-id="1fdf9-544">**PerceptionSimulation (ISimulationRecording).**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-544">**Microsoft.PerceptionSimulation.ISimulationRecording.Seek(System.UInt64)**</span></span>

<span data-ttu-id="1fdf9-545">지정 된 시간 (시작부터 100 나노초 간격)에 대 한 기록을 검색 하 고 해당 위치에서 일시 중지 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-545">Seeks the recording to the specified time (in 100 nanoseconds intervals from the beginning) and pauses at that location.</span></span> <span data-ttu-id="1fdf9-546">시간이 기록의 끝을 초과 하면 마지막 프레임에서 일시 중지 됩니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-546">If the time is beyond the end of the recording, it is paused at the last frame.</span></span>

<span data-ttu-id="1fdf9-547">매개 변수</span><span class="sxs-lookup"><span data-stu-id="1fdf9-547">Parameters</span></span>
* <span data-ttu-id="1fdf9-548">틱-검색 하는 시간입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-548">ticks - The time to which to seek.</span></span>

<span data-ttu-id="1fdf9-549">**PerceptionSimulation. ISimulationRecording**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-549">**Microsoft.PerceptionSimulation.ISimulationRecording.Stop**</span></span>

<span data-ttu-id="1fdf9-550">재생을 중지 하 고 위치를 시작 부분으로 다시 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-550">Stops the playback and resets the position to the beginning.</span></span>

### <a name="microsoftperceptionsimulationisimulationrecordingcallback"></a><span data-ttu-id="1fdf9-551">PerceptionSimulation. ISimulationRecordingCallback</span><span class="sxs-lookup"><span data-stu-id="1fdf9-551">Microsoft.PerceptionSimulation.ISimulationRecordingCallback</span></span>

<span data-ttu-id="1fdf9-552">재생 하는 동안 상태 변경을 수신 하기 위한 인터페이스입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-552">Interface for receiving state changes during playback.</span></span>
...
<span data-ttu-id="1fdf9-553">**PerceptionSimulation. ISimulationRecordingCallback PlaybackStateChanged (PerceptionSimulation Backstate)**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-553">**Microsoft.PerceptionSimulation.ISimulationRecordingCallback.PlaybackStateChanged(Microsoft.PerceptionSimulation.PlaybackState)**</span></span>

<span data-ttu-id="1fdf9-554">ISimulationRecording의 재생 상태가 변경 될 때 호출 됩니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-554">Called when an ISimulationRecording's playback state has changed.</span></span>

<span data-ttu-id="1fdf9-555">매개 변수</span><span class="sxs-lookup"><span data-stu-id="1fdf9-555">Parameters</span></span>
* <span data-ttu-id="1fdf9-556">newState-기록의 새 상태입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-556">newState - The new state of the recording.</span></span>

### <a name="microsoftperceptionsimulationperceptionsimulationmanager"></a><span data-ttu-id="1fdf9-557">PerceptionSimulation. PerceptionSimulationManager</span><span class="sxs-lookup"><span data-stu-id="1fdf9-557">Microsoft.PerceptionSimulation.PerceptionSimulationManager</span></span>

<span data-ttu-id="1fdf9-558">인식 시뮬레이션 개체를 만들기 위한 루트 개체입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-558">Root object for creating Perception Simulation objects.</span></span>
...
<span data-ttu-id="1fdf9-559">**PerceptionSimulation PerceptionSimulationManager. CreatePerceptionSimulationManager (PerceptionSimulation)**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-559">**Microsoft.PerceptionSimulation.PerceptionSimulationManager.CreatePerceptionSimulationManager(Microsoft.PerceptionSimulation.ISimulationStreamSink)**</span></span>

<span data-ttu-id="1fdf9-560">시뮬레이션 된 패킷을 생성 하 여 제공 된 싱크에 전달 하기 위해 개체에를 만듭니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-560">Create on object for generating simulated packets and delivering them to the provided sink.</span></span>

<span data-ttu-id="1fdf9-561">매개 변수</span><span class="sxs-lookup"><span data-stu-id="1fdf9-561">Parameters</span></span>
* <span data-ttu-id="1fdf9-562">sink-생성 된 모든 패킷을 수신 하는 싱크입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-562">sink - The sink that will receive all generated packets.</span></span>

<span data-ttu-id="1fdf9-563">반환 값</span><span class="sxs-lookup"><span data-stu-id="1fdf9-563">Return value</span></span>

<span data-ttu-id="1fdf9-564">만든 관리자입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-564">The created Manager.</span></span>

<span data-ttu-id="1fdf9-565">**PerceptionSimulation PerceptionSimulationManager. CreatePerceptionSimulationRecording (System.string)**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-565">**Microsoft.PerceptionSimulation.PerceptionSimulationManager.CreatePerceptionSimulationRecording(System.String)**</span></span>

<span data-ttu-id="1fdf9-566">받은 모든 패킷을 파일의 지정 된 경로에 저장 하는 싱크를 만듭니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-566">Create a sink which stores all received packets in a file at the specified path.</span></span>

<span data-ttu-id="1fdf9-567">매개 변수</span><span class="sxs-lookup"><span data-stu-id="1fdf9-567">Parameters</span></span>
* <span data-ttu-id="1fdf9-568">path-만들 파일의 경로입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-568">path - The path of the file to create.</span></span>

<span data-ttu-id="1fdf9-569">반환 값</span><span class="sxs-lookup"><span data-stu-id="1fdf9-569">Return value</span></span>

<span data-ttu-id="1fdf9-570">만든 싱크입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-570">The created sink.</span></span>

<span data-ttu-id="1fdf9-571">**PerceptionSimulation. PerceptionSimulationManager, LoadPerceptionSimulationRecording (System.string, PerceptionSimulation)**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-571">**Microsoft.PerceptionSimulation.PerceptionSimulationManager.LoadPerceptionSimulationRecording(System.String,Microsoft.PerceptionSimulation.ISimulationStreamSinkFactory)**</span></span>

<span data-ttu-id="1fdf9-572">지정 된 파일에서 기록을 로드 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-572">Load a recording from the specified file.</span></span>

<span data-ttu-id="1fdf9-573">매개 변수</span><span class="sxs-lookup"><span data-stu-id="1fdf9-573">Parameters</span></span>
* <span data-ttu-id="1fdf9-574">path-로드할 파일의 경로입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-574">path - The path of the file to load.</span></span>
* <span data-ttu-id="1fdf9-575">팩터리-필요할 때 ISimulationStreamSink를 만들기 위해 기록에서 사용 하는 팩터리입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-575">factory - A factory used by the recording for creating an ISimulationStreamSink when required.</span></span>

<span data-ttu-id="1fdf9-576">반환 값</span><span class="sxs-lookup"><span data-stu-id="1fdf9-576">Return value</span></span>

<span data-ttu-id="1fdf9-577">로드 된 기록입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-577">The loaded recording.</span></span>

<span data-ttu-id="1fdf9-578">**PerceptionSimulation, PerceptionSimulationManager, LoadPerceptionSimulationRecording (System.string, PerceptionSimulation, ISimulationStreamSinkFactory, PerceptionSimulation)**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-578">**Microsoft.PerceptionSimulation.PerceptionSimulationManager.LoadPerceptionSimulationRecording(System.String,Microsoft.PerceptionSimulation.ISimulationStreamSinkFactory,Microsoft.PerceptionSimulation.ISimulationRecordingCallback)**</span></span>

<span data-ttu-id="1fdf9-579">지정 된 파일에서 기록을 로드 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-579">Load a recording from the specified file.</span></span>

<span data-ttu-id="1fdf9-580">매개 변수</span><span class="sxs-lookup"><span data-stu-id="1fdf9-580">Parameters</span></span>
* <span data-ttu-id="1fdf9-581">path-로드할 파일의 경로입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-581">path - The path of the file to load.</span></span>
* <span data-ttu-id="1fdf9-582">팩터리-필요할 때 ISimulationStreamSink를 만들기 위해 기록에서 사용 하는 팩터리입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-582">factory - A factory used by the recording for creating an ISimulationStreamSink when required.</span></span>
* <span data-ttu-id="1fdf9-583">콜백-녹화 상태를 다시 보고 하는 업데이트를 수신 하는 콜백입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-583">callback - A callback which receives updates regrading the recording's status.</span></span>

<span data-ttu-id="1fdf9-584">반환 값</span><span class="sxs-lookup"><span data-stu-id="1fdf9-584">Return value</span></span>

<span data-ttu-id="1fdf9-585">로드 된 기록입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-585">The loaded recording.</span></span>

### <a name="microsoftperceptionsimulationstreamdatatypes"></a><span data-ttu-id="1fdf9-586">PerceptionSimulation 데이터 형식</span><span class="sxs-lookup"><span data-stu-id="1fdf9-586">Microsoft.PerceptionSimulation.StreamDataTypes</span></span>

<span data-ttu-id="1fdf9-587">다양 한 유형의 스트림 데이터를 설명 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-587">Describes the different types of stream data.</span></span>
...
<span data-ttu-id="1fdf9-588">**PerceptionSimulation 데이터 형식입니다.**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-588">**Microsoft.PerceptionSimulation.StreamDataTypes.None**</span></span>

<span data-ttu-id="1fdf9-589">스트림 데이터 형식이 없음을 나타내는 데 사용 되는 센티널 값입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-589">A sentinel value used to indicate no stream data types.</span></span>

<span data-ttu-id="1fdf9-590">**PerceptionSimulation. Head**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-590">**Microsoft.PerceptionSimulation.StreamDataTypes.Head**</span></span>

<span data-ttu-id="1fdf9-591">헤드의 위치와 방향에 대 한 데이터 스트림입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-591">Stream of data regarding the position and orientation of the head.</span></span>

<span data-ttu-id="1fdf9-592">**PerceptionSimulation. 직접**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-592">**Microsoft.PerceptionSimulation.StreamDataTypes.Hands**</span></span>

<span data-ttu-id="1fdf9-593">바늘의 위치 및 제스처와 관련 된 데이터 스트림입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-593">Stream of data regarding the position and gestures of hands.</span></span>

<span data-ttu-id="1fdf9-594">**PerceptionSimulation. SpatialMapping**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-594">**Microsoft.PerceptionSimulation.StreamDataTypes.SpatialMapping**</span></span>

<span data-ttu-id="1fdf9-595">환경의 공간 매핑에 대 한 데이터 스트림입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-595">Stream of data regarding spatial mapping of the environment.</span></span>

<span data-ttu-id="1fdf9-596">**PerceptionSimulation. 보정**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-596">**Microsoft.PerceptionSimulation.StreamDataTypes.Calibration**</span></span>

<span data-ttu-id="1fdf9-597">장치의 보정에 대 한 데이터 스트림입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-597">Stream of data regarding calibration of the device.</span></span> <span data-ttu-id="1fdf9-598">원격 모드의 시스템 에서만 보정 패킷을 허용 합니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-598">Calibration packets are only accepted by a system in Remote Mode.</span></span>

<span data-ttu-id="1fdf9-599">**PerceptionSimulation. 환경**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-599">**Microsoft.PerceptionSimulation.StreamDataTypes.Environment**</span></span>

<span data-ttu-id="1fdf9-600">장치 환경에 대 한 데이터 스트림입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-600">Stream of data regarding the environment of the device.</span></span>

<span data-ttu-id="1fdf9-601">**PerceptionSimulation. SixDofControllers**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-601">**Microsoft.PerceptionSimulation.StreamDataTypes.SixDofControllers**</span></span>

<span data-ttu-id="1fdf9-602">동작 컨트롤러에 대 한 데이터 스트림입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-602">Stream of data regarding motion controllers.</span></span>

<span data-ttu-id="1fdf9-603">**PerceptionSimulation입니다.**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-603">**Microsoft.PerceptionSimulation.StreamDataTypes.Eyes**</span></span>

<span data-ttu-id="1fdf9-604">시뮬레이션 된 사람의 눈에 대 한 데이터 스트림입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-604">Stream of data regarding the eyes of the simulated human.</span></span>

<span data-ttu-id="1fdf9-605">**PerceptionSimulation를 구성 합니다.**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-605">**Microsoft.PerceptionSimulation.StreamDataTypes.DisplayConfiguration**</span></span>

<span data-ttu-id="1fdf9-606">장치의 디스플레이 구성과 관련 된 데이터 스트림입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-606">Stream of data regarding the display configuration of the device.</span></span>

<span data-ttu-id="1fdf9-607">**PerceptionSimulation 데이터 형식**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-607">**Microsoft.PerceptionSimulation.StreamDataTypes.All**</span></span>

<span data-ttu-id="1fdf9-608">기록 된 모든 데이터 형식을 나타내는 데 사용 되는 센티널 값입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-608">A sentinel value used to indicate all recorded data types.</span></span>

### <a name="microsoftperceptionsimulationisimulationstreamsink"></a><span data-ttu-id="1fdf9-609">PerceptionSimulation. ISimulationStreamSink</span><span class="sxs-lookup"><span data-stu-id="1fdf9-609">Microsoft.PerceptionSimulation.ISimulationStreamSink</span></span>

<span data-ttu-id="1fdf9-610">시뮬레이션 스트림에서 데이터 패킷을 수신 하는 개체입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-610">An object that receives data packets from a simulation stream.</span></span>
...
<span data-ttu-id="1fdf9-611">**PerceptionSimulation ISimulationStreamSink. OnPacketReceived (uint length, byte [] packet)**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-611">**Microsoft.PerceptionSimulation.ISimulationStreamSink.OnPacketReceived(uint length, byte[] packet)**</span></span>

<span data-ttu-id="1fdf9-612">는 내부적으로 형식화 되 고 버전이 지정 되는 단일 패킷을 받습니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-612">Receives a single packet, which is internally typed and versioned.</span></span>

<span data-ttu-id="1fdf9-613">매개 변수</span><span class="sxs-lookup"><span data-stu-id="1fdf9-613">Parameters</span></span>
* <span data-ttu-id="1fdf9-614">length-패킷의 길이입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-614">length - The length of the packet.</span></span>
* <span data-ttu-id="1fdf9-615">packet-패킷의 데이터입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-615">packet - The data of the packet.</span></span>

### <a name="microsoftperceptionsimulationisimulationstreamsinkfactory"></a><span data-ttu-id="1fdf9-616">PerceptionSimulation. ISimulationStreamSinkFactory</span><span class="sxs-lookup"><span data-stu-id="1fdf9-616">Microsoft.PerceptionSimulation.ISimulationStreamSinkFactory</span></span>

<span data-ttu-id="1fdf9-617">ISimulationStreamSink을 만드는 개체입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-617">An object that creates ISimulationStreamSink.</span></span>
...
<span data-ttu-id="1fdf9-618">**PerceptionSimulation ISimulationStreamSinkFactory. CreateSimulationStreamSink ()**</span><span class="sxs-lookup"><span data-stu-id="1fdf9-618">**Microsoft.PerceptionSimulation.ISimulationStreamSinkFactory.CreateSimulationStreamSink()**</span></span>

<span data-ttu-id="1fdf9-619">ISimulationStreamSink의 단일 인스턴스를 만듭니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-619">Creates a single instance of ISimulationStreamSink.</span></span>

<span data-ttu-id="1fdf9-620">반환 값</span><span class="sxs-lookup"><span data-stu-id="1fdf9-620">Return value</span></span>

<span data-ttu-id="1fdf9-621">만든 싱크입니다.</span><span class="sxs-lookup"><span data-stu-id="1fdf9-621">The created sink.</span></span>
