...
#### [HoloLens(1세대) 하드웨어 세부 정보](hololens-hardware-details.md)
#### [HoloLens 계정](accounts-on-hololens.md)
#### [조정](calibration.md)
#### [상용 기능](commercial-features.md)
#### [HoloLens에서 Wi-Fi에 연결](connecting-to-wi-fi-on-hololens.md)
#### [HoloLens의 환경 고려 사항](environment-considerations-for-hololens.md)
#### [HoloLens용 앱 다운로드](get-apps-for-hololens.md)
...
### [입력 체계](typography.md)
### [배율](scale.md)
### [사례 연구 - HoloTour의 공간 음향 디자인](case-study-spatial-sound-design-for-holotour.md)
## 앱 패턴
### [혼합 현실 앱의 종류](types-of-mixed-reality-apps.md)
...
### [사용자 지정 집 환경 추가](add-custom-home-environments.md)
...
##### [MR 및 Azure 302b: 사용자 지정 비전](mr-azure-302b.md)
##### [MR 및 Azure 303: 자연어 이해](mr-azure-303.md)
##### [MR 및 Azure 304: 얼굴 인식](mr-azure-304.md)
##### [MR 및 Azure 305: 기능 및 스토리지](mr-azure-305.md)
##### [MR 및 Azure 306: 비디오 스트리밍](mr-azure-306.md)
##### [MR 및 Azure 307: 기계 학습](mr-azure-307.md)
##### [MR 및 Azure 308: 디바이스 간 알림](mr-azure-308.md)
##### [MR 및 Azure 309: 애플리케이션 인사이트](mr-azure-309.md)
##### [MR 및 Azure 310: 개체 탐지](mr-azure-310.md)
