---
layout: LandingPage
title: Academy-코드, 자습서 및 단원
description: 혼합 현실 Academy 혼합된 현실 개발에 대 한 코드 샘플 및 자습서를 제공합니다.
author: keveleigh
ms.author: kurtie
ms.date: 03/21/2018
ms.topic: article
...
ms.locfileid: "59600880"
---
# <a name="academy-code-tutorials-and-lessons"></a>Academy: 코드, 자습서 및 단원
...
San Francisco의 원자로 공간에는 오프 라인 혼합 현실 Academy도 있습니다. 물리적 Academy 공간 또는 예정 된 이벤트에 대 한 정보를 찾고 있는 경우 [여기를 클릭](#microsoft-reactor) 또는이 페이지의 아래쪽으로 스크롤합니다.
...
<h3><a href="https://developer.microsoft.com/reactor/">샌프란시스코에서 Microsoft 원자로</a></h3>
<p>
샌프란시스코에서 Microsoft 원자로 680 위치한 Folsom에서 SOMA, 혼합 현실 캡처 Studio 및 혼합 현실 아카데미의 주력 위치를 사용 하는 데 사용 됩니다. 개발자 및 작성자 Microsoft HoloLens 및 Windows Mixed Reality 헤드셋에 대 한 혼합된 현실 환경 구축의 여정을 시작할 수 있는 위치를 마련입니다.</p>

[예정 된 세션과 워크숍, 해커 톤 공지 확인](sf-academy-events.md)
